...
const Asidebar = () => {
  ...
  const userRole = currentUserMember?.role?.name;
      ...
      <Sidebar collapsible="icon">
        <SidebarHeader className="!py-0 dark:bg-background">
          <div className="flex h-[50px] items-center justify-start w-full px-1">
            <Logo url="http://localhost:3000" />
            {open && (
              <a
                href="http://localhost:3000"
                className="hidden md:flex ml-2 items-center gap-2 self-center font-medium hover:opacity-80 transition-opacity"
              >
                Exonium
              </a>
            )}
