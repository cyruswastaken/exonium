...
const Footer = () => {
  return (
    <footer className="container-lg flex flex-wrap border-t border-[hsla(0,0%,100%,.08)] bg-[#000212] pt-14">
      <div className="mb-5 flex w-full items-center justify-between lg:mb-10 lg:mr-auto lg:w-fit lg:flex-col">
      ...
      {/* <h1 className="mx-auto mb-5 mt-16 text-sm font-light">
        developed by kiro, cursor, copilot, openAI
      </h1> */}
    </footer>
  );
};
